...
--```lua
--DanLib.Outline.drawOutline( 32, 16, 10, 64, 64, { color_white, color_black }, nil, 8 )
--DanLib.Outline.drawOutline( 32, 102, 10, 64, 64, { color_white, color_transparent }, nil, 8 )
--DanLib.Outline.drawOutline( 32, 192, 10, 64, 64, { color_black, ColorAlpha( color_black, 0 ) }, nil, 8 )
---```
...
-- DanLib.Outline.drawOutline( 32, 32, 18, 64, 64, { color1, color2 }, nil, 16 )
---```
---@class DanLib.outlines
local outlines = {}
...
do
	...
	function outlines:GenerateSingle(mesh, radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, l, t, r, b, curviness, inside, cornernessArg)
		...
		meshBegin(mesh, PRIMITIVE_TRIANGLE_STRIP, DanLib.RoundedBoxe:getMeshVertexCount(radius, rightTop, rightBottom, leftBottom, leftTop) * 2)
			DanLib.RoundedBoxe:generateSingleMesh(createVertex, nil, radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, 0, 0, 1, 1, curviness)
		meshEnd()
	end
end
...
do
	...
	---@private Internal variable, not meant to be used outside.
	function outlines:DrawSingle(radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, material, l, t, r, b, curviness, inside, cornerness)
		curviness = curviness or 2
		...
		if (meshObj == nil) then
			...
			self:GenerateSingle(meshObj, radius, 0, 0, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, l, t, r, b, curviness, inside, cornerness)
...
do
	...
	---@param curviness number?
	---@private Internal variable, not meant to be used outside.
	function outlines:DrawBatched(radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, _, l, t, r, b, curviness)
		outlineL, outlineT, outlineR, outlineB = l, t, r, b
		first = true
		curviness = curviness or 2
		z = incrementZ()
		DanLib.RoundedBoxe:generateSingleMesh(createVertex, nil, radius, x, y, x + w, y + h, leftTop, rightTop, rightBottom, leftBottom, colors, 0, 0, 1, 1, curviness)
	end
end
...
do
	...
	function outlines:DrawEx(radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, material, l, t, r, b, curviness, inside, cornerness)
		if (colors[2] == nil) then colors = getColorTable(2, colors) end
		...
		if batch.batching then
			self:DrawBatched(radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, material, l, t, r, b, curviness)
		else
			self:DrawSingle(radius, x, y, w, h, leftTop, rightTop, rightBottom, leftBottom, colors, material, l, t, r, b, curviness, inside, cornerness)
		end
	end
	...
	function outlines:Draw(radius, x, y, w, h, colors, material, l, t, r, b, curviness, inside, cornerness)
		self:DrawEx(radius, x, y, w, h, true, true, true, true, colors, material, l, t, r, b, curviness, inside, cornerness)
	end
end
...
do
	...
	---@return IMesh
	---@private Internal variable, not meant to be used outside.
	function outlines:GenerateBox(x, y, endX, endY, colors, outlineL, outlineT, outlineR, outlineB)
	...
	function outlines:drawBoxOutline(x, y, w, h, colors, outlineL, outlineT, outlineR, outlineB)
		...
		if (mesh == nil) then
			mesh = self:GenerateBox(0, 0, w, h, colors, outlineL, outlineT, outlineR, outlineB)
